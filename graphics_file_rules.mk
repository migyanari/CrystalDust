...
$(TYPESGFXDIR)/move_types_es.4bpp: $(INTERFACEGFXDIR)/spanish/menu_info.4bpp $(TYPESGFXDIR)/move_types.4bpp
	python3 tools/extract_type_icons.py $(INTERFACEGFXDIR)/spanish/menu_info.4bpp $(TYPESGFXDIR)/move_types.4bpp $@
