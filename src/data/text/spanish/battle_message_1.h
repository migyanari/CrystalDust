...
static const u8 sText_PkmnIgnoredX[] = _("¡{B_OPPONENT_MON1_NAME} ignoró por completo\n{B_BUFF1}!");
...
static const u8 sText_TwoTrainersSentPkmn[] = _("¡{B_OPPONENT_MON1_NAME} es el POKéMON enviado\npor {B_TRAINER1_CLASS} {B_TRAINER1_NAME}!\p¡{B_BUFF1} es el POKéMON enviado\npor {B_TRAINER2_CLASS} {B_TRAINER2_NAME}!");
static const u8 sText_Trainer2SentOutPkmn[] = _("¡{B_BUFF1} es el POKéMON enviado\npor {B_TRAINER2_CLASS} {B_TRAINER2_NAME}!");
static const u8 sText_TwoTrainersWantToBattle[] = _("¡A luchar contra {B_TRAINER1_CLASS} {B_TRAINER1_NAME}\ny {B_TRAINER2_CLASS} {B_TRAINER2_NAME}!\p");
static const u8 sText_InGamePartnerSentOutZGoN[] = _("¡{B_PARTNER_CLASS} {B_PARTNER_NAME} envió\na {B_PLAYER_MON2_NAME}!\l¡Adelante, {B_PLAYER_MON1_NAME}!");
static const u8 sText_TwoInGameTrainersDefeated[] = _("¡Has derrotado a {B_TRAINER1_CLASS} {B_TRAINER1_NAME}\ny {B_TRAINER2_CLASS} {B_TRAINER2_NAME}!\p");
static const u8 sText_Trainer2LoseText[] = _("{B_TRAINER2_LOSE_TEXT}");
static const u8 sText_PkmnIncapableOfPower[] = _("¡Parece que {B_ATK_NAME_WITH_PREFIX} no es capaz\nde usar su fuerza!");
...
static const u8 sText_RefIfNothingIsDecided[] = _("JUEZ: Si en 3 turnos no hay decisión,\n¡pasaremos al veredicto!");
...
const u8 gText_RecordBattleToPass[] = _("¿Quieres grabar tu último\nenfrentamiento en el PASE del FRENTE?");
const u8 gText_BattleRecordedOnPass[] = _("Se grabó el resultado del último\nenfrentamiento de {B_PLAYER_NAME}\pen el PASE del FRENTE.");
